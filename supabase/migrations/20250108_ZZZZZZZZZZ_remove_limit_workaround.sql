-- ========================================
-- WORKAROUND: Return only Bloom 1 unlocked arms
-- ========================================
-- PostgREST has 1000 row limit we can't override
-- Since we only use unlocked arms anyway, filter to just those
...
BEGIN
  ...
  SELECT * FROM unlocked_arms WHERE is_unlocked = true
  ORDER BY topic, bloom_level;
END;
