-- Fix get_available_arms to return topic_id (required by TypeScript code)
...
COMMENT ON FUNCTION get_available_arms IS 'Get available (topic, bloom_level) arms for Thompson Sampling. Returns topic_id for proper matching.';
