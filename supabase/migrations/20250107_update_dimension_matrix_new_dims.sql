...
COMMENT ON FUNCTION get_topic_dimension_matrix IS 'Returns full (Bloom × Dimension) matrix with adaptive mastery calculation. Uses new 6 dimension system: definition, example, comparison, scenario, implementation, troubleshooting.';
