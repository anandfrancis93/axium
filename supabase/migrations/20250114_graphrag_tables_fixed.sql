-- GraphRAG Tables Migration (Fixed - No user_profiles dependency)
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS graphrag_indexing_jobs (
...
CREATE INDEX IF NOT EXISTS idx_graphrag_indexing_jobs_chapter ON graphrag_indexing_jobs(chapter_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_indexing_jobs_status ON graphrag_indexing_jobs(status);
...
CREATE INDEX IF NOT EXISTS idx_graphrag_entities_chapter ON graphrag_entities(chapter_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_entities_type ON graphrag_entities(type);
CREATE INDEX IF NOT EXISTS idx_graphrag_entities_name ON graphrag_entities(name);
CREATE INDEX IF NOT EXISTS idx_graphrag_entities_neo4j ON graphrag_entities(neo4j_id);

-- HNSW index for vector similarity search on entities
CREATE INDEX IF NOT EXISTS idx_graphrag_entities_embedding ON graphrag_entities
...
CREATE INDEX IF NOT EXISTS idx_graphrag_relationships_chapter ON graphrag_relationships(chapter_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_relationships_source ON graphrag_relationships(source_entity_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_relationships_target ON graphrag_relationships(target_entity_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_relationships_type ON graphrag_relationships(relationship_type);
CREATE INDEX IF NOT EXISTS idx_graphrag_relationships_neo4j ON graphrag_relationships(neo4j_id);
...
CREATE INDEX IF NOT EXISTS idx_graphrag_communities_chapter ON graphrag_communities(chapter_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_communities_level ON graphrag_communities(level);
CREATE INDEX IF NOT EXISTS idx_graphrag_communities_parent ON graphrag_communities(parent_community_id);

-- ============================================================================
-- 5. GraphRAG Query Cache (cache expensive graph queries)
-- ============================================================================
CREATE TABLE IF NOT EXISTS graphrag_query_cache (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_graphrag_query_cache_hash ON graphrag_query_cache(query_hash);
CREATE INDEX IF NOT EXISTS idx_graphrag_query_cache_chapter ON graphrag_query_cache(chapter_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_query_cache_expires ON graphrag_query_cache(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_graphrag_metrics_question ON graphrag_metrics(question_id);
CREATE INDEX IF NOT EXISTS idx_graphrag_metrics_mode ON graphrag_metrics(rag_mode);
CREATE INDEX IF NOT EXISTS idx_graphrag_metrics_bloom ON graphrag_metrics(bloom_level);

-- ============================================================================
-- RLS Policies (SIMPLIFIED - No user_profiles dependency)
-- ============================================================================

-- Allow authenticated users to read (for question generation)
ALTER TABLE graphrag_indexing_jobs ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Authenticated users can read indexing jobs"
...
CREATE POLICY "Authenticated write access to entities"
  ON graphrag_entities
  FOR INSERT
  WITH CHECK (auth.role() = 'authenticated');
...
CREATE POLICY "Authenticated write access to relationships"
  ON graphrag_relationships
  FOR INSERT
  WITH CHECK (auth.role() = 'authenticated');
...
CREATE POLICY "Authenticated write access to communities"
  ON graphrag_communities
  FOR INSERT
  WITH CHECK (auth.role() = 'authenticated');

-- Query cache: public read, authenticated write
...
CREATE POLICY "Authenticated write access to query cache"
  ON graphrag_query_cache
  FOR INSERT
  WITH CHECK (auth.role() = 'authenticated');
...
CREATE POLICY "Authenticated write access to metrics"
  ON graphrag_metrics
  FOR INSERT
  WITH CHECK (auth.role() = 'authenticated');
