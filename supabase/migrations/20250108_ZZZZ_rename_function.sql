-- ========================================
-- RENAME FUNCTION TO FORCE NEW CACHE KEY
-- ========================================
-- Supabase RPC caching is too aggressive
-- Rename function to get_available_arms_v2 to force new cache key
...
COMMENT ON FUNCTION get_available_arms_v2 IS 'Get available (topic, bloom_level) arms for Thompson Sampling (v2 - renamed to bypass cache)';

-- Verify
DO $$
BEGIN
  RAISE NOTICE 'Function renamed to get_available_arms_v2 to force cache invalidation';
END $$;
