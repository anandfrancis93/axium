-- Part 2: Create the new function with updated signature
-- This must be run AFTER part 1
...
DO $$
BEGIN
  RAISE NOTICE 'Function get_available_arms has been created successfully with topic_full_name column';
END $$;
