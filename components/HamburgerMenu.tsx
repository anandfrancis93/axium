        ...
        >
          <MenuIcon size={20} />
                ...
                {isOpen && (
                  ...
                  <div className="absolute right-0 mt-4 w-72 neuro-card origin-top-right animate-scale-in overflow-hidden z-50">

                    {/* User Info */}

                    <div className="mb-4">

                      <div className="neuro-raised flex items-center gap-3 p-3">
                      ...
                      >
                        ...
                        <LogOutIcon size={18} className="transition-transform group-hover:-translate-x-1" />
